...
import { forwardMessage } from "./GraphService";
...
export default function ForwardMessage() {
  ...
  const doForward = async () => {
    ...
    try {
      await forwardMessage(app.authProvider!, newForwardMessage, mailId);
      setRedirect(true);
    } catch (err) {
  ...
  return (
    <Form>
      ...
      <Button color="primary" className="me-2" onClick={() => doForward()}>
        Create
      </Button>
